...
# Create data frames from each proportion table
df_t1_hot_prop  <- prop_to_df(ACTMQ_t1_hot_prop,  "hot memory")
df_t1_cold_prop <- prop_to_df(ACTMQ_t1_cold_prop, "cold memory")
...
# Create data frames from each proportion table
df_t2_hot_prop  <- prop_to_df(ACTMQ_t2_hot_prop,  "hot memory")
df_t2_cold_prop <- prop_to_df(ACTMQ_t2_cold_prop, "cold memory")
...
# Create data frames from each proportion table
df_t3_hot_prop  <- prop_to_df(ACTMQ_t3_hot_prop,  "hot memory")
df_t3_cold_prop <- prop_to_df(ACTMQ_t3_cold_prop, "cold memory")
