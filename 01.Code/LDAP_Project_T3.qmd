...
```{r}
#| label: ‘Hypothesis Diagram’
#| echo: false
#| output: true

knitr::include_graphics("../02.Figures/hyp_diagram.png")
...
A Cross-Lagged Panel Model (CLPM) is a type of statistical model used to understand how different variables influence each other over time. In CLPM, both autoregressive and cross-lagged paths are modelled together

## Cross-Lagged Panel Model (CLPM)

A Cross-Lagged Panel Model (CLPM) is a type of statistical model used to understand how different variables influence each other over time. In CLPM, both autoregressive and cross-lagged paths are modelled together

**Autoregressive paths:** how a variable predicts itself over time (e.g. beliefs at T1 → beliefs at T2)

**Cross-lagged paths:** how one variable predicts a different variable over time (e.g. beliefs at T1 → memory at T2, or memory at T1 → beliefs at T2)
